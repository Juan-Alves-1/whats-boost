...
from app.controllers.api import text_api_controller, media_api_controller, image_up_api_controller, image_up_logo_api_controller
...
app.include_router(image_up_logo_api_controller.router, tags=["Image upload with logo"]) # Upload image to the provider
